...
### [10] [XNET: Intelligent Dynamic Sampling for High-Speed Network Security Monitoring](https://arxiv.org/abs/2608.18349)
...
### [11] [AdaRare: Telemetry-Guided Joint Profile Control for Greybox Fuzzing](https://arxiv.org/abs/2608.18187)
...
### [12] [VQC-ZTI: Variational Quantum Control for Zero Trust Protection of the Tactile Internet](https://arxiv.org/abs/2608.18572)
...
### [13] [Model Card for OpenAI Privacy Filter](https://arxiv.org/abs/2608.18274)
...
### [14] [Autonomous Cyber Defense in Connected Vehicles: A Multi-Agent Approach to V2X Security](https://arxiv.org/abs/2608.19135)
*Krishna Teja Medam*
...
### [15] [SiNMULI: Novel Signed Network Approach for Malicious URL Identification](https://arxiv.org/abs/2608.19190)
...
### [16] [Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents](https://arxiv.org/abs/2608.18351)
...
### [17] [0xPass: A Secure Protocol for Universal Cross-Chain Accounts](https://arxiv.org/abs/2608.18359)
...
### [18] [AoNT Trap: Borromean-Entangled Mutable Chameleon Trapdoor Hash All-or-Nothing Stream Cipher](https://arxiv.org/abs/2608.18403)
*Victor Kebande*
...
### [19] [Beyond Distortion Robustness: Rethinking Severe Cropping as Erasure-Resilient Message Embedding](https://arxiv.org/abs/2608.18567)
...
### [20] [Finality Before Disclosure for Ledger Authenticators in the Quantum Random Oracle Model](https://arxiv.org/abs/2608.18605)
...
### [21] [IriSig-Spoof: A Real-World Benchmark for Time-Robust Satellite RF Fingerprinting and Spoofing Detection](https://arxiv.org/abs/2608.18642)
...
### [22] [Improving LLM-Based SSH Honeypots Through Prompting and Fine-Tuning](https://arxiv.org/abs/2608.18686)
...
### [23] [CauSec: Unboxing the Causal Drivers of Static Vulnerability Analysis Performance](https://arxiv.org/abs/2608.18876)
...
### [24] [Who Can Make the Action Happen? An Authority-Decomposition Framework for High-Risk Automated Systems](https://arxiv.org/abs/2608.18965)
...
### [25] [Catastrophic Learning: A New Attack Vector on Continual Learning Networks](https://arxiv.org/abs/2608.18976)
...
### [26] [A 12-Step Process for Industrial Internet of Things (IIoT) Forensics](https://arxiv.org/abs/2608.18991)
*Victor Kebande*
...
### [27] [From Threat Intelligence to Detection: Knowledge-driven Enrichment and Template-based Rule Grounding for Automated Sigma Rule Generation](https://arxiv.org/abs/2608.19011)
...
### [28] [Malformer: A Multi-Modal Malware Detector Using Transformers](https://arxiv.org/abs/2608.19052)
...
### [29] [Toward Quantum Advantage in Learning Parities with Structured Noise via Lower Bound Optimization of the Condition Number](https://arxiv.org/abs/2608.19122)
...
### [30] [FedGuard-DC: Privacy-Preserving Federated Load Forecasting and Cyber-Attack Detection for Data-Center Loads in Transmission Systems](https://arxiv.org/abs/2608.19155)
...
### [31] [The Structured Totient Preimage Problem: Reconstruction, Collisions, and Cryptographic Implications](https://arxiv.org/abs/2608.19191)
...
### [32] [Near-MDS codes of lengths q+6 and q+7 from conics in PG(2,q), q odd](https://arxiv.org/abs/2608.18192)
...
### [33] [Second-Order Asymptotics for the Gaussian Multiple-Access Channel at Corner Points](https://arxiv.org/abs/2608.18231)
*Vincent Y. F. Tan*
...
### [34] [Quickest Change Detection in Parametric Models With 1-Bit Measurements](https://arxiv.org/abs/2608.18391)
...
### [35] [Joint Beamforming and Phase Shifts Design for RIS-Enabled RSMA-ISAC Systems](https://arxiv.org/abs/2608.18458)
...
### [36] [A Tutorial on Weight Structure of Polar Codes](https://arxiv.org/abs/2608.18493)
...
### [37] [GCNO: Gramian Chebyshev Neural Operator for Physics-Based Compression of Wireless Channels](https://arxiv.org/abs/2608.18522)
...
### [38] [Constructing Good Abelian Codes via Shift Bounds and Genetic Algorithms](https://arxiv.org/abs/2608.18664)
...
### [39] [Joint Power Allocation and Phase-Shift Design for Beyond-Diagonal Stacked Intelligent Metasurfaces-Aided ISAC Systems](https://arxiv.org/abs/2608.18713)
...
### [41] [Integrated Sensing and Communications over Hierarchical Cellular and Cell-Free MIMO Systems](https://arxiv.org/abs/2608.18873)
...
### [42] [New Constructions of Additive MDS TRS Codes](https://arxiv.org/abs/2608.18904)
...
### [43] [The Equality Cases of the Weak Simplex Conjecture](https://arxiv.org/abs/2608.19093)
...
### [44] [Entropy-Constrained Adaptive Stochastic Quantization](https://arxiv.org/abs/2608.18147)
...
### [45] [Towards Reversible Forgetting: Managing Obsolete Knowledge in Continual Enterprise AI Agents](https://arxiv.org/abs/2608.18177)
...
### [46] [Accelerating Visual On-Policy Distillation with Batched Speculative Jacobi Rollouts](https://arxiv.org/abs/2608.18183)
...
### [47] [H$^2$EDL: Hyper Evidential Deep Learning for Hierarchical Classification](https://arxiv.org/abs/2608.18185)
...
### [48] [What Can Artificial Intelligence Learn from Medicine? Generative Analogies and Reliable Machine Learning Systems](https://arxiv.org/abs/2608.18186)
...
### [49] [A systematic review of machine learning techniques to address diagnosis and treatment of autism: challenges and opportunities](https://arxiv.org/abs/2608.18188)
...
### [50] [Safe Domain Adaptation for Physics: Overcoming Nuisances, Label Shifts, and Simulation Priors](https://arxiv.org/abs/2608.18190)
*Ivan Kharuk*
...
### [51] [ChiroEcho: extending automated bat vocalisation classification beyond the learned taxonomy](https://arxiv.org/abs/2608.18191)
...
### [52] [Think Shallow, Solve Deep: Controlling Recurrent Dynamics for Reliable Test-Time Depth](https://arxiv.org/abs/2608.18222)
...
### [53] [Allocating Recurrent Compute in Looped Language Models](https://arxiv.org/abs/2608.18230)
...
### [54] [Multi-Agent Off-Policy Deep Reinforcement Learning for Smart Campus Coverage](https://arxiv.org/abs/2608.19049)
...
### [55] [Classifying Directional Trajectories Near Criticality in the Three-State Majority-Vote Model with Deep Belief Networks and Bidirectional GRUs](https://arxiv.org/abs/2608.18235)
...
### [56] [ClosureBench: A Constructive Benchmark for Compositional Graph Reasoning](https://arxiv.org/abs/2608.18242)
*Stefano Goria*
...
### [57] [Bidirectional representational alignment between biological and artificial neural networks](https://arxiv.org/abs/2608.18244)
...
### [58] [SIGMA: Symmetry-aware, Intelligent, Geometric, Multi-objective Adaptive Control for Robust, Dependable Traffic Management](https://arxiv.org/abs/2608.18263)
...
### [59] [Rethinking Privileged Information in On-Policy Self-Distillation](https://arxiv.org/abs/2608.18271)
...
### [60] [SingularClip: Preventing Spectral Collapse to Maintain Plasticity in Continual and Reinforcement Learning](https://arxiv.org/abs/2608.18319)
...
### [61] [Calibrating Adaptive Smoothing Methods for Freeway Traffic Reconstruction](https://arxiv.org/abs/2602.02072)
...
### [62] [When Does Dynamic Ensembling Pay Off? Diagnosing Regionwise Gains in Regression under Distribution Shift](https://arxiv.org/abs/2608.18330)
...
### [63] [Selection, Recombination, or a Fresh Solve? A Candidate-Free Control for Single-Pass Test-Time Aggregation](https://arxiv.org/abs/2608.18379)
*Guiv Farmanfarmaian*
...
### [64] [Vector Symbolic Policy Gradient](https://arxiv.org/abs/2608.18404)
...
### [65] [Role-Conditioned Sub-Token Routing for Efficient Vision-Language-Action Policies](https://arxiv.org/abs/2608.18410)
*Wei Jiang,Wei Wang*
...
### [66] [The Road Taken: The Role of Optimizers at the Edge of Stability](https://arxiv.org/abs/2608.18415)
...
### [67] [Mechanistic Interpretability of Structure-Aware Numerical Reasoning in LLaMA 3.1 8B](https://arxiv.org/abs/2608.18419)
...
### [68] [Adaptive Multi-Agent Feature Selection for Personalized Fall Risk Prevention](https://arxiv.org/abs/2608.18450)
...
### [69] [Denoising-Aware Inversion: Revealing Privacy Risks in Noise-Protected Text Embeddings](https://arxiv.org/abs/2608.18610)
...
### [70] [Atrial Fibrillation Detection with Arbitrary Leads via a Codebook-Based Reconstruction-Classification Framework](https://arxiv.org/abs/2608.18451)
...
### [71] [FedLNS: Leverage LayerNorm Signature Modeling to Mitigate Adversarial Manipulation in Federated LLMs](https://arxiv.org/abs/2608.18736)
...
### [72] [ERASE: EaRly bAckpropagation SchEdule for Faster Training of Modern Recommendation Systems](https://arxiv.org/abs/2608.18469)
...
### [73] [Geometric Data Perturbation with Noisy-Anchor Alignment for Privacy-Preserving Collaborative Learning](https://arxiv.org/abs/2608.18749)
...
### [74] [Physics-Unrolled Neural Operator for Wireless Field Modeling](https://arxiv.org/abs/2608.18495)
...
### [75] [Tianmu-TC: Physics-constraints Generative Artificial Intelligence for Global Tropical Cyclone Forecasting](https://arxiv.org/abs/2608.18500)
...
### [76] [LLM-Powered Predictive Decision-Making for Sustainable Data Center Operations](https://arxiv.org/abs/2608.18503)
...
### [77] [Evaluating and Explaining Prompt Sensitivity of LLMs Using Interactions](https://arxiv.org/abs/2608.18539)
...
### [78] [MARCUS: Missing-Aware Region Representation with Contextual Urban Signals for Rent Prediction](https://arxiv.org/abs/2608.18546)
...
### [79] [Performance Drift Detection in Machine Learning as a Service (MLaaS) for IoT Environments](https://arxiv.org/abs/2608.18555)
...
### [80] [MorphoGP: A Nonparametric Framework for Predicting Equilibrium Beach Profiles Under Tidal Influence](https://arxiv.org/abs/2608.18558)
...
### [81] [NanoSleep: A Parameter-Efficient Hybrid Temporal Convolutional Network for Single-Channel Sleep Stage Classification](https://arxiv.org/abs/2608.18571)
...
### [82] [Continual Reasoning Gym: Diagnosing and Harnessing Shared Reasoning in Continual RLVR](https://arxiv.org/abs/2608.18574)
...
### [83] [Beyond receptive fields: sequence-pooled normalization can supply most of a sequence labeler's context](https://arxiv.org/abs/2608.18576)
*Qing Tian*
...
### [84] [Infrared Universality of Collective Dynamics across Transformer and State-Space Architectures](https://arxiv.org/abs/2608.18592)
*Byung Gyu Chae*
...
### [85] [Off-Manifold Collapse in Guided Protein Language Models](https://arxiv.org/abs/2608.18597)
...
### [86] [Scalable Geospatial Machine Learning for Power-Line Asset Risk: Integrating Remote Sensing for Lightning and Vegetation Risk Modelling](https://arxiv.org/abs/2608.18611)
...
### [88] [ProxyGuard: Direct Reliability Inference for Randomized Data Release Mechanisms with Shared Targets](https://arxiv.org/abs/2608.18643)
...
### [89] [FlashAttention for Scalable Vector Architectures](https://arxiv.org/abs/2608.18656)
...
### [90] [Computational Measurement of Team-Process Phase Dynamics in Collaborative Virtual Reality](https://arxiv.org/abs/2608.18660)
...
### [91] [Reinforced Planning with Latent World Models](https://arxiv.org/abs/2608.18669)
...
### [93] [Transforming Heart Disease Prediction with Advanced Machine Learning Techniques](https://arxiv.org/abs/2608.18687)
...
### [94] [Europe's Climate Ambition Under Scrutiny: Evidence from Deep Learning Emission Projections](https://arxiv.org/abs/2608.18690)
...
### [95] [Multi-Class Electrical and Mechanical Fault Classification Using Random Convolutional Kernels](https://arxiv.org/abs/2608.18716)
...
### [96] [Visual-Aware Representation of Web Pages for Machine Learning Applications](https://arxiv.org/abs/2608.18727)
...
### [97] [Decision-Metric Alignment in Latent World Models: Diagnostics and Action-Conditioned Objectives for MPC Planning](https://arxiv.org/abs/2608.18746)
...
### [98] [Beyond Predictive Fairness: Quantifying Attribution Consistency Across Demographic Groups in Diabetic Retinopathy Screening](https://arxiv.org/abs/2608.18759)
...
### [99] [Enhancing Distance-Based Graph Autoencoders with Structural Penalties for Dynamic Graph Embedding](https://arxiv.org/abs/2608.18762)
...
### [100] [To Go Far, Go Together: Diverse Preferences Induce a Curriculum for Reward Optimization](https://arxiv.org/abs/2608.18770)
...
### [101] [GraphK: Variable-Size Graph Generation with Efficient Edge Construction](https://arxiv.org/abs/2608.18777)
...
### [102] [A Real-Time Tsetlin Machine-based Non-intrusive Load Monitoring System on MCUs](https://arxiv.org/abs/2608.18780)
...
### [103] [Forgetting, plasticity, and co-observation: a third facet of continual learning](https://arxiv.org/abs/2608.18803)
...
### [104] [Tensor Field Models](https://arxiv.org/abs/2608.18808)
...
### [105] [Many Optimizers But Only One Training Path: Repeated Resampling for Adaptive Optimizer Selection](https://arxiv.org/abs/2608.18810)
...
### [106] [A Unifying Relational Perspective on Expressive Lottery Tickets](https://arxiv.org/abs/2608.18819)
...
### [107] [MLREF: Efficient Module Reuse for Reward Design in Reinforcement Learning via Large Language Models](https://arxiv.org/abs/2608.18827)
...
### [108] [GEAR: Generative Expansion and Real Anchoring for Two-Stage Distillation of Tabular Foundation Models](https://arxiv.org/abs/2608.18849)
...
### [109] [Multi-stage neural operator learning with application for convolutions](https://arxiv.org/abs/2608.18851)
...
### [110] [Graph-Based Approaches to Learning Epileptogenic Zone Localization Using Stereo-EEG Recordings](https://arxiv.org/abs/2608.18887)
...
### [111] [A FEM-Based Surrogate Modelling and Optimization Framework for Physics-Constrained Electromagnetic Coil Design](https://arxiv.org/abs/2608.18903)
*Yucheng Liu*
...
### [112] [On the Slow Convergence to Trivial Solutions of Algorithms for Hard Optimization Problems](https://arxiv.org/abs/2608.18910)
...
### [113] [Converting Expert Deliberation into Financial Signals Through A Context-Aware NLP Pipeline](https://arxiv.org/abs/2608.18911)
...
### [114] [Score the Algebra, Not the Span: Dimension Reduction for Transfer Operator Models of Dynamical Systems](https://arxiv.org/abs/2608.18918)
...
### [115] [Lost in Aggregation: How Benchmarks Overlook Irreplaceable Model Strengths](https://arxiv.org/abs/2608.18919)
...
### [116] [Transportable Causal Effect Estimation across Networks under Interference](https://arxiv.org/abs/2608.18932)
...
### [117] [Graphical Design of Interpretable Architectures](https://arxiv.org/abs/2608.18936)
*Pietro Barbiero*
...
### [118] [Training Chemical Plausibility-Aware Large Language Models for Single-Step Retrosynthesis](https://arxiv.org/abs/2608.18940)
...
### [119] [Fuzzy Accuracy Compensates for Label Subjectivity in Classification of Skin Tone Using Wearable Photoplethysmography Signals](https://arxiv.org/abs/2608.18969)
...
### [120] [Monroe: A Molecular Foundation Model for In-Context Probabilistic Inference](https://arxiv.org/abs/2608.18982)
...
### [121] [Harness Continual Learning: Continual Adaptation Beyond Model Parameters](https://arxiv.org/abs/2608.19013)
...
### [122] [Does Mapping Non-Maximal Probabilities to GMM Components Matter for S-JEPA Encoder Representations?](https://arxiv.org/abs/2608.19084)
...
### [123] [Open-MOPD: Diagnosing and Fixing Capability Imbalance in Multi-Teacher On-Policy Distillation](https://arxiv.org/abs/2608.19098)
...
### [124] [Pretraining Reusable Inference Across Views with Synthetic Task Priors](https://arxiv.org/abs/2608.19115)
...
### [125] [Enhancing EBSD throughput of battery electrode materials using super-resolution generative adversarial networks](https://arxiv.org/abs/2608.19117)
...
### [126] [Discretizing Continuous Time Series for Imputation with Masked Diffusion Training](https://arxiv.org/abs/2608.19119)
...
### [127] [PGFS++: Molecular Property Improvement under Synthesis and Diversity Constraints](https://arxiv.org/abs/2608.19121)
...
### [128] [Leaf Values as Coordinates: Exact Contrastive Explanation for Gradient-Boosted Ensembles](https://arxiv.org/abs/2608.19127)
*Emanuele Luzio*
...
### [129] [Beyond Trial Averaging: Anchoring Neural and Visual Representations for Few-Repetition Brain-to-Image Retrieval](https://arxiv.org/abs/2608.19128)
...
### [130] [SCORE: Subject Coordinate Recovery for Label-Free Cross-Subject EEG-to-Image Retrieval](https://arxiv.org/abs/2608.19134)
...
### [131] [Bridge Graphical Models: Coupling, Projection, and Current-Preserving Dynamics for Generative Modeling](https://arxiv.org/abs/2608.19144)
*Tiantian Zhang*
...
### [132] [Continuous-Time Reinforcement Learning for Controlled Hawkes Jump-Diffusions](https://arxiv.org/abs/2608.19151)
...
### [133] [Learned, Then Lost: A Measured Single-Example Counterfactual in Pre-training](https://arxiv.org/abs/2608.19168)
...
### [134] [Lévy Attention: Single-Pass Predictive Uncertainty for Continuous-Time Attention](https://arxiv.org/abs/2608.19171)
...
### [135] [Beyond Teacher Likelihood: Group-Calibrated On-Policy Distillation for Long-Context Reasoning](https://arxiv.org/abs/2608.19181)
...
### [136] [Real-Time Design of Public Transport Lines: Reconciling Adaptivity and Efficiency](https://arxiv.org/abs/2608.18314)
...
### [137] [A Benchmark Graph Dataset for Transient Stability Assessment of the IEEE 9-Bus System: 20,000 Scenarios with Full Generator Trajectories](https://arxiv.org/abs/2608.18318)
...
### [138] [Model Predictive Supervisory Control for Hierarchical and Distributed UAS Traffic Management](https://arxiv.org/abs/2608.18353)
...
### [139] [LiDAR-Derived Surface Priors for Multimodal Sensing-Assisted NLoS Beam Search in Indoor 60-GHz Networks](https://arxiv.org/abs/2608.18396)
...
### [140] [Power Estimation and Optimal Work-Charging Scheduling of Construction Electric Vehicles via Mobile Charging Stations](https://arxiv.org/abs/2608.18494)
...
### [141] [Toward Controllability-Aware Performance Measures: A Case Study on Controllable Highway Congestion](https://arxiv.org/abs/2608.18510)
...
### [142] [Exact Robust Instability Analysis for Networked Dynamical Systems with Biological Application](https://arxiv.org/abs/2608.18553)
...
### [143] [Robust Instability Radius for Networked Dynamical Systems: Upper and Lower Bounds](https://arxiv.org/abs/2608.18561)
*Shinji Hara,Yutaka Hori,Tetsuya Iwasaki,Chung-Yao Kao,Sei Zhen Khong*
...
### [144] [Toward S^2C^2I-Integrated High-Altitude Platforms: Architectures, Cross-Functional Design, Evaluation, and Deployment Perspectives](https://arxiv.org/abs/2608.18587)
...
### [145] [Payload Swing Estimation and Damping Without Payload Parameters for Multirotor UAVs](https://arxiv.org/abs/2608.18625)
*K. Taki,K. Umemoto*
...
### [146] [Adaptive Nonlinear Control with Online Identification and Receding-Horizon Optimization](https://arxiv.org/abs/2608.18717)
*Igor Ladnik*
...
### [147] [Detecting Feedback-path Delay Injection Attacks Using Interacting Multiple Model Filtering](https://arxiv.org/abs/2608.18824)
...
### [148] [Robust Joint Planning of EV and eBus Charging Infrastructure with PV Self-Consumption under Demand Uncertainty](https://arxiv.org/abs/2608.18844)
*Biswarup Mukherjee*
...
### [149] [Comparing Controller Synthesis Methods with Deadline-Miss Awareness](https://arxiv.org/abs/2608.18850)
...
### [150] [Deciding Relabeling Observation Consistency in Multi-Agent Discrete-Event Systems](https://arxiv.org/abs/2608.18866)
*Tomáš Masopust*
...
### [151] [Limitations of RMS-based Stability Assessment of Converter-based Grids: A Case Study](https://arxiv.org/abs/2608.18989)
