...
### [1] [WIP: Energy-Efficient LLM-Based Serving Cluster Formulation in Cell-Free Massive MIMO](https://arxiv.org/abs/2609.05725)
...
### [2] [SDN-Orchestrated Dual-Path 5G/SATCOM Maritime Communications for Carrier Strike Groups](https://arxiv.org/abs/2609.05729)
...
### [3] [Semantic Communication for Distributed Spectrum Monitoring over Unreliable Links](https://arxiv.org/abs/2609.05791)
...
### [4] [HalifaxDT: A Wireless Digital Twin from Open Geospatial Data](https://arxiv.org/abs/2609.05793)
...
### [5] [Comparative Performance of Graphene-Enabled Transmitarray Antenna and Reflectors for Wide-Angle Terahertz Beam Steering](https://arxiv.org/abs/2609.05803)
...
### [6] [Biased Backpressure Routing for Multihop Wireless Networks with Heterogeneous Interfaces](https://arxiv.org/abs/2609.05844)
...
### [7] [SLA-Safe Energy Control for AI-Native NG-RAN Using Stability-Aware Constrained PPO](https://arxiv.org/abs/2609.05861)
*Dharmendra Kumar*
...
### [8] [AhaBench: Do Agents Learn from Prior Experience? A Benchmark for Long-Horizon Continual Learning](https://arxiv.org/abs/2609.05435)
...
### [9] [When Do Options Help? Policy Necrosis and Redundant Coverage in Option-Critic](https://arxiv.org/abs/2609.05508)
...
### [10] [Multi-granularity Adaptive Hypergraph Representation Learning via Granular-ball](https://arxiv.org/abs/2609.05574)
...
### [12] [HB-PVI: A Hierarchical Bayesian Personalization and Value-of-Information Framework for Complex Activity Recognition](https://arxiv.org/abs/2609.05582)
*Hammed A. Olayinka*
...
### [13] [Endogenous Exploration in Reinforcement Learning with Intrinsic Curiosity](https://arxiv.org/abs/2609.05650)
*Armando Vieira*
...
### [14] [Robustness of LLM-Generated SystemVerilog Assertions to Semantics-Preserving RTL Transformations](https://arxiv.org/abs/2609.05658)
*FNU Aditi*
...
### [15] [Resilient Control Loops in Autonomous Vehicles Under Adversarial Jamming via Spectral Perception and Network-Layer Failover](https://arxiv.org/abs/2609.05739)
...
### [16] [Practical Zero-Trust for Mission-Critical Robotic Fleets via Hardware Attestation and Packet Timing Watermarking](https://arxiv.org/abs/2609.05741)
...
### [17] [AgentHomeID - Agent-based modelling of building stock transformation: A multi-scale framework for policy assessment and infrastructure planning](https://arxiv.org/abs/2609.05763)
...
### [18] [Bidirectional Wireless Communication for Weakly Coupled Implantable Brain-Computer Interfaces](https://arxiv.org/abs/2609.05786)
...
### [19] [Multimodal Large Language Model-guided Constrained Optimization for RAN Intelligent Control](https://arxiv.org/abs/2609.06122)
*Hyeonho Noh*
...
### [20] [Fixed-Time Integral Reinforcement Learning for Saturated Nonlinear Multi-Agent Systems Under FDI Attacks](https://arxiv.org/abs/2609.06163)
...
### [21] [Non-parametric Formal Synthesis of Unknown Stochastic Systems: Asymptotic Convergence Guarantees](https://arxiv.org/abs/2609.06206)
...
### [22] [Recursive overlap Bernoulli distributions and an entropy concavity conjecture](https://arxiv.org/abs/2609.05546)
*Jörg Neunhäuserer*
...
### [23] [A Nuclear-Norm Lower Bound for Dithered Scalar Quantization of Matrix Products](https://arxiv.org/abs/2609.05641)
...
### [24] [Moments of crosscorrelation demerit factors of binary sequences](https://arxiv.org/abs/2609.05771)
...
### [25] [Algorithmic List Decoding at Capacity and Optimal Proximity Gaps for Reed-Solomon Codes](https://arxiv.org/abs/2609.05870)
...
### [26] [Cadence: Error-Bounded Lossy Compression of Demand Time Series with a Time-Series Foundation Model](https://arxiv.org/abs/2609.06008)
*Roberto Tacconelli*
...
### [27] [Fundamental Limits of Adaptive Beamforming Under Finite Training](https://arxiv.org/abs/2609.06136)
...
### [28] [Rank and classification of $\mathbb{Z}_2\mathbb{Z}_4\mathbb{Z}_8$-linear Hadamard codes](https://arxiv.org/abs/2609.06244)
*Dipak K. Bhunia*
...
### [29] [Scaling Bayesian Bandit Encoding with Shared Learning](https://arxiv.org/abs/2609.06293)
...
### [30] [A Graph Foundation Model for Large-Scale MIMO Detection](https://arxiv.org/abs/2609.06361)
...
### [31] [Optimal-Access Cooperative MSR Codes: Parity-Check Matrix Construction And a Unified Transformation](https://arxiv.org/abs/2609.06372)
...
### [32] [From Tsallis to KL: Convergence and Error Estimates for Tsallis-Regularized Optimal Transport](https://arxiv.org/abs/2609.06432)
...
### [33] [Constructions of complete permutations over $\mathbb{F}_q^n$](https://arxiv.org/abs/2609.05564)
...
### [34] [Reaching the Cards Apple Wallet Leaves Behind: Direct NFC Acquisition of PRO100, HUMO and UZCARD Payment Cards on iOS](https://arxiv.org/abs/2609.05627)
*Gusein Djalilov*
...
### [36] [Bait-and-Recover: Poisoning Internal Refusal Signals to Defend LLMs against White-Box Editing Jailbreaks](https://arxiv.org/abs/2609.05794)
...
### [37] [From Review to Authorization: Key-Isolated Threshold Signing for LLM Agents](https://arxiv.org/abs/2609.05901)
...
### [38] [EvoSafeHarness: Evolving Model- and Domain-Specific Harnesses for Securing Agents](https://arxiv.org/abs/2609.05903)
...
### [39] [Structurally Close, Temporally Distant: Measuring Security Exposure in Long-Horizon LLM Agents](https://arxiv.org/abs/2609.05911)
...
### [40] [Beyond UDP: RDMA as the Missing Link for Gigasample Software-Defined Radio](https://arxiv.org/abs/2609.05623)
...
### [41] [Joint Average Contiguous Duration of Correlated Fading Envelopes](https://arxiv.org/abs/2609.05642)
...
### [42] [Wideband HF Skywave Propagation: A Review with Link Modeling Corroborated by Propagation Data](https://arxiv.org/abs/2609.05811)
...
### [43] [Inverse Stochastic Filtering for Inverse Cognition in Counter-adversarial systems](https://arxiv.org/abs/2609.05915)
*Himali Singh*
...
### [44] [Terahertz Inter-Satellite Links: Motivation, Challenges and Opportunities](https://arxiv.org/abs/2609.05973)
...
### [45] [Pinching Antenna Assisted Integrated Sensing and Communication Using Quadrature RSMA](https://arxiv.org/abs/2609.05987)
...
### [46] [Scalability of Graph Neural Network Policies in Wireless Communication Networks](https://arxiv.org/abs/2609.06066)
