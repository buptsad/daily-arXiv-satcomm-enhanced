...
### [1] [Bounded Deep Unfolding for Joint Beamforming and Scheduling in Multi-Cell MIMO Networks](https://arxiv.org/abs/2606.05246)
...
### [2] [X-Band UAV-enabled Integrated Sensing and Communications for Vehicular Networks](https://arxiv.org/abs/2606.05262)
...
### [3] [Unlocking Exponential and Unbounded Robust Gains in Shannon Capacity of Classical Multiple Access Channels with Causal CSIT via Quantum Entanglement Assistance](https://arxiv.org/abs/2606.05412)
...
### [4] [Sequence Reconstruction for Substitution Channel: New Sufficient Conditions and Algorithms](https://arxiv.org/abs/2606.05454)
...
### [5] [Robust Repair of Reed-Solomon Codes](https://arxiv.org/abs/2606.05573)
...
### [10] [Adapting Diffusion Language Models for Lossless Pixel-Level Image Transmission](https://arxiv.org/abs/2606.06273)
...
### [11] [A Spherical Stochastic Geometry Framework for Patrol-Based HAPs Network: Coverage and Energy Efficiency Analysis](https://arxiv.org/abs/2606.06307)
...
### [12] [Reversible double cyclic codes over a chain ring](https://arxiv.org/abs/2606.06367)
...
### [13] [CAPE: Control Algorithm Performance Evaluation under Learned Vehicle Dynamics Models](https://arxiv.org/abs/2606.05480)
...
### [14] [Electromagnetic Characterization of magnetic ring: Case of square cross section shape](https://arxiv.org/abs/2606.05485)
...
### [15] [Constrained Deep Reinforcement Learning for Cognitive Radar Resource Management](https://arxiv.org/abs/2606.05526)
...
### [16] [Learning-Assisted Day-Ahead Energy Scheduling for Frequency-Secure Inverter-Dominated Grids with Grid-Forming Battery Energy Storage Systems](https://arxiv.org/abs/2606.05534)
...
### [17] [Development of a Structured Approach for Establishing Mission Engineering Requirements](https://arxiv.org/abs/2606.05651)
...
### [18] [Tracking Control for a Dynamic Model of an Underwater Submersible](https://arxiv.org/abs/2606.05709)
...
### [19] [Physics-Informed Graph Learning Acceleration for Large-Scale AC-OPF with Topology Changes](https://arxiv.org/abs/2606.05772)
...
### [20] [Impact of RTK Augmentation and INS Integration on GNSS Positioning Accuracy and Continuity: A Benchmarking Study on Inland Waterways](https://arxiv.org/abs/2606.06358)
...
### [21] [Efficient Multi-Agent Optimization of Optical Power in S+C+L-Band Systems](https://arxiv.org/abs/2606.05795)
...
### [22] [Amortized Nonlinear Model Predictive Control](https://arxiv.org/abs/2606.05840)
...
### [23] [Mixed Potential Approach to Convergence of Nonlinear RLC Circuits with Memristors](https://arxiv.org/abs/2606.05851)
...
### [24] [Voltage Unbalance-Aware AC Optimal Power Flow in Distribution Networks](https://arxiv.org/abs/2606.06167)
...
### [25] [From data to decisions: Bayesian modelling and global sensitivity analysis for flotation control](https://arxiv.org/abs/2606.06173)
...
### [26] [Attack Detection using Time Series Foundation Models](https://arxiv.org/abs/2606.06347)
...
### [27] [Expected String Stability of Human-Led Vehicle Platoons under Stochastic Communication Delays (Full Version)](https://arxiv.org/abs/2606.06406)
...
### [28] [Domain-Conditioned Safety in Frontier Computer-Using Agents: A 793-Episode Browser Benchmark, a Coding-Domain Cross-Reference, and a Reproducibility Audit of Recent Red-Teaming](https://arxiv.org/abs/2606.05233)
*Nicholas Saban*
...
### [29] [Search-Time Contamination in Deep Research Agents: Measuring Performance Inflation in Public Benchmark Evaluation](https://arxiv.org/abs/2606.05241)
...
### [30] [From Attack Simulation to SIEM Rule: Deterministic Detection-as-Code Synthesis with Probe-Level Traceability](https://arxiv.org/abs/2606.05252)
...
### [31] [Willing but Unable: Separating Refusal from Capability in Code LLMs via Abliteration](https://arxiv.org/abs/2606.05396)
...
### [32] [A formal framework for the economic security of DeFi compositions](https://arxiv.org/abs/2606.05418)
...
### [33] [Policy-Compliant Cloud Storage Systems](https://arxiv.org/abs/2606.05423)
...
### [34] [CRESS: Quantifying Vulnerabilities of Attack Scenarios in Hardware Reverse Engineering](https://arxiv.org/abs/2606.05459)
...
### [35] [SHIELDS: Automating OS Hardening with Iterative Multi-Agent Remediation](https://arxiv.org/abs/2606.05476)
...
### [36] [Bitcoin After Block Rewards](https://arxiv.org/abs/2606.05503)
*Junhyuk Lee*
...
### [37] [ZERO-APT: A Closed-Loop Adversarial Framework for LLM-Driven Automated Penetration Testing under Intelligent Defense](https://arxiv.org/abs/2606.05567)
...
### [38] [Dimensionality Reduction for Cyberattack Classification: A Comparative Evaluation of PCA and Linear Predictive Coding](https://arxiv.org/abs/2606.05584)
...
### [39] [The Coverage Gap: Chile's Cyber Disclosure Framework versus the USA, EU and UK](https://arxiv.org/abs/2606.05594)
*David Mellafe Z*
...
### [40] [SlotGCG: Exploiting the Positional Vulnerability in LLMs for Jailbreak Attacks](https://arxiv.org/abs/2606.05609)
...
### [42] [Cognitive Threat Intelligence and Explainable Federated Security Analytics for distributed Infrastructure Systems](https://arxiv.org/abs/2606.05701)
...
### [43] [Explainable AI-Driven Cyber Risk Analytics and Model Reliability Assessment for Intelligent Governance of U.S. Critical Infrastructure: An XGBoost and SHAP-Based Intrusion Detection Framework](https://arxiv.org/abs/2606.05710)
...
### [44] [Hybrid CNN-LSTM Framework for Intelligent Cyber Attack Detection and Prevention in U.S. Critical Digital Infrastructure: A Comparative Machine Learning Evaluation on CSE-CIC-IDS2018](https://arxiv.org/abs/2606.05714)
...
### [45] [An Embarrassingly Simple Detector for Model Extraction Attacks in Large Language Model API Traffic](https://arxiv.org/abs/2606.05725)
...
### [46] [Membrane: A Self-Evolving Contrastive Safety Memory for LLM Agent Defense](https://arxiv.org/abs/2606.05743)
...
### [47] [An Improved CNN-LSTM Based Intrusion Detection System for IoT Networks](https://arxiv.org/abs/2606.05776)
...
### [48] [TinyML-Driven Cybersecurity for Autonomous Spacecraft: Latency-Accuracy Analysis for SPARTA RF and Cyber Threat Detection](https://arxiv.org/abs/2606.05779)
...
### [49] [SentinelRAG: Synthetic Sentinel Knowledge for RAG Database Copyright Protection](https://arxiv.org/abs/2606.05787)
...
### [50] [GCD: Garbled, Corrected, Demonstrandum -- Fixing and Proving Go's Extended GCD Implementation](https://arxiv.org/abs/2606.05796)
*Linard Arquint*
...
### [51] [PriSrv: Privacy-Enhanced and Highly Usable Service Discovery in Wireless Communications](https://arxiv.org/abs/2606.05821)
...
### [52] [Towards Worst-case Hardness for Low-Noise LPN](https://arxiv.org/abs/2606.05834)
...
### [53] [GenTI: Benchmarking LLMs for Autonomous IDPS Rule Generation for Unseen Attacks](https://arxiv.org/abs/2606.05844)
...
### [54] [PriSrv+: Privacy and Usability-Enhanced Wireless Service Discovery with Fast and Expressive Matchmaking Encryption](https://arxiv.org/abs/2606.05902)
...
### [55] [Exploring the connection between coding habits and cognitive styles in malware developers](https://arxiv.org/abs/2606.05945)
...
### [56] [AttackPathGNN: Cross-function vulnerability detection in smart contracts using state interference graphs and conjunction pooling](https://arxiv.org/abs/2606.05986)
...
### [57] [Cheating in Multiplayer Online Games: a Dataset](https://arxiv.org/abs/2606.06013)
...
### [58] [RedEdit: Agentic Red-Teaming of Image Safety Classifiers via MCTS-Guided Photo-Editing](https://arxiv.org/abs/2606.06140)
...
### [59] [Opportunities and Challenges in Securely Reusing and Repurposing Mobile Devices](https://arxiv.org/abs/2606.06181)
...
### [60] [Steering LLM Viewpoints through Fabricated Evidence Injection](https://arxiv.org/abs/2606.06244)
...
### [61] [SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation](https://arxiv.org/abs/2606.06254)
...
### [62] [Robust Ensemble of Selectively Strengthened and Augmented Predictors](https://arxiv.org/abs/2606.06265)
...
### [63] [Credential Disclosure in (EU) Digital Identity Wallets: Privacy Risks and Practical Mitigations](https://arxiv.org/abs/2606.06354)
...
### [64] [WebMCP Tool Surface Poisoning: Runtime Manipulation Attacks on LLM Agents](https://arxiv.org/abs/2606.06387)
...
### [65] [Will the Agent Recuse Itself? Measuring LLM-Agent Compliance with In-Band Access-Deny Signals](https://arxiv.org/abs/2606.06460)
...
### [66] [Availability-Aware and Efficiency-Driven AI Service Chain Provisioning in Multi-Domain Edge Intelligence Cloud](https://arxiv.org/abs/2606.05637)
...
### [67] [AISC deployment in dynamic UAV-assisted MEC network: a reinforcement learning method based on heterogeneous graph attention neural network](https://arxiv.org/abs/2606.05722)
...
### [68] [BeGREEN Intelligent Plane for AI-driven Energy Efficient O-RAN management](https://arxiv.org/abs/2606.05747)
...
### [69] [Quantifying the Energy-Saving and QoS Trade-Off in Traffic Offloading for Real 4G/5G Scenarios](https://arxiv.org/abs/2606.05752)
...
### [70] [Toward Mobile and Converged Backhaul: The Promise of Wireless Access and Backhaul](https://arxiv.org/abs/2606.06075)
...
### [71] [DAST: A VLM-LLM Framework for Cross-Interface Anomaly Detection in O-RAN](https://arxiv.org/abs/2606.06261)
...
### [72] [The Evaluation Blind Spot: A Stereological Theory of Benchmark Coverage for Large Language Models](https://arxiv.org/abs/2606.05169)
*Jason Z Wang*
...
### [73] [ERRORQUAKE: Heavy-Tailed Error Severity Distributions in Open-Weight Large Language Models](https://arxiv.org/abs/2606.05170)
*Jason Z Wang*
...
### [74] [Staged Factorial Screening for Budget-Constrained Micro-Pretraining](https://arxiv.org/abs/2606.05186)
...
### [75] [PyCC.id: A package for hypothesis-driven equation discovery with structural identifiability](https://arxiv.org/abs/2606.05191)
*Federico J. Gonzalez*
...
### [76] [Temporal Preference Concepts and their Functions in a Large Language Model](https://arxiv.org/abs/2606.05194)
...
### [77] [State commitment learning: training language models to distinguish computation from memory](https://arxiv.org/abs/2606.05201)
...
### [78] [Gradient Descent with Large Step Size Restores Symmetry in Deep Linear Networks with Multi-Pathway](https://arxiv.org/abs/2606.05219)
...
### [80] [Differentiable Efficient Operator Search](https://arxiv.org/abs/2606.05232)
...
### [81] [DiffSlack: Learning under Nonlinear Inequality Constraints via Learnable Slack Variables](https://arxiv.org/abs/2606.05247)
...
### [82] [Alpha-RTL: Test-Time Training for RTL Hardware Optimization](https://arxiv.org/abs/2606.05253)
...
### [83] [Flash-WAM: Modality-Aware Distillation for World Action Models](https://arxiv.org/abs/2606.05254)
...
### [84] [Scaling Laws for Behavioral Foundation Models over User Event Sequences](https://arxiv.org/abs/2606.05257)
...
### [85] [Policy-Conditioned Counterfactual Credit for Verifiable Reinforcement Learning of Long-Horizon Language Agents](https://arxiv.org/abs/2606.05263)
*Renwei Meng*
...
### [86] [Beyond Soft Masks: Hard-Perturbation Mixup Explainer for Robust GNN Explainability](https://arxiv.org/abs/2606.05756)
...
### [93] [Agentic Monte Carlo: Simulating Reinforcement Learning for Black-Box Agents](https://arxiv.org/abs/2606.05296)
*Dae Yon Hwang,Raunaq Suri,Valentin Villecroze,Anthony L. Caterini,Jesse C. Cresswell,Noël Vouitsis,Brendan Leigh Ross*

Main category: cs.LG

TL;DR: 利用序列蒙特卡洛与价值函数，AMC能直接采样黑箱LLM的最优策略，超越提示和GRPO，在AgentGym上得到显著提升。


<details>
  <summary>Details</summary>
Motivation: 传统RL需要模型可训练参数，而API-only的黑箱LLM无法进行参数级优化，使得大多数RL方法失效；本文欲通过贝叶斯推断视角实现对黑箱代理的控制。

Method: AMC将黑箱LLM视为轨迹先验，通过序列蒙特卡洛采样后验（即最优策略），在采样过程中学习价值函数以引导代理行为，最终得到最优策略的样本。

Result: 在AgentGym基准的三种多样环境中，AMC在增强测试时计算量的同时，显著优于提示基线，甚至在规模化后超过GRPO。

Conclusion: 本文表明，通过Agentic Monte Carlo（AMC）可以在不修改底层黑箱LLM模型的前提下，以贝叶斯推断框架实现类似RL的最优策略优化，证明了黑箱LLM代理的合理RL式优化可行。
...
### [94] [Statistically Reliable LLM-Based Ranking Evaluation via Prediction-Powered Inference](https://arxiv.org/abs/2606.05308)
*Abhishek Divekar*
...
### [95] [Multimarginal flow matching with optimal transport potentials](https://arxiv.org/abs/2606.05327)
...
### [96] [A prism hierarchy of learning regimes in large linear autoencoders](https://arxiv.org/abs/2606.05335)
...
### [97] [PJ-RoPE: A Fourier-Jet-Affine Position Space for Relative Attention](https://arxiv.org/abs/2606.05345)
*Yaobo Zhang*
...
### [98] [Mamba-Assisted Non-Markovian Closure for Reduced-Order Modeling](https://arxiv.org/abs/2606.05371)
...
### [99] [Evidence-Guided Neural Architecture Selection under Uncertainty for Subject-Specific Blood Glucose Forecasting](https://arxiv.org/abs/2606.05373)
...
### [100] [SHALA-LLM: Smartly Handling Ambiguous Labels in Aligning LLMs](https://arxiv.org/abs/2606.05376)
...
### [101] [Pattern Selectivity is Not Task-Causal Structure: A Cross-Architecture Mechanistic Study of Composed-Task Circuits in 1B-Class Language Models](https://arxiv.org/abs/2606.05378)
*Yongzhong Xu*
...
### [102] [Generalized TV--$\ell_p$ Structured Priors for Bayesian $T_1$ Mapping](https://arxiv.org/abs/2606.05381)
...
### [103] [Trust, but Don't Verify: Epistemic Blind Spots in LLM Source Evaluation](https://arxiv.org/abs/2606.05403)
...
### [104] [CausalPOI: Spatio-Temporal Graph-Based Causal Modeling for Cold-Start POI Check-in Forecasting](https://arxiv.org/abs/2606.05413)
...
### [105] [Selective-Advantage Entropy-Adaptive Horizon GRPO: Asymmetric Token-Level Discounting for Efficient Reinforcement Learning of Language Models](https://arxiv.org/abs/2606.05434)
...
### [106] [DP-MacAdam: Differentially Private Mechanism with Adaptive Clipping and Adaptive Momentum](https://arxiv.org/abs/2606.05435)
...
### [107] [Sharp First-Order Lower Bounds for Higher-Order Smooth Nonconvex Optimization](https://arxiv.org/abs/2606.05438)
*Dongruo Zhou*
...
### [108] [GOTabPFN: From Feature Ordering to Compact Tokenization for Tabular Foundation Models on High-Dimensional Data](https://arxiv.org/abs/2606.05441)
...
### [109] [Towards Unified and Data-Efficient Prognostics and Health Management with Tabular Foundation Models](https://arxiv.org/abs/2606.05481)
...
### [110] [Learned Subspace Compression for Communication-Efficient Pipeline Parallelism](https://arxiv.org/abs/2606.05484)
...
### [111] [LEVANTE-bench: Multi-Scale Comparison of VLMs to Children Using Cognitive Tasks (or, "Is Your VLM Smarter Than a 5th Grader?")](https://arxiv.org/abs/2606.05497)
...
### [112] [Dominant-Layer ZO: A Single Layer Dominates Zeroth-Order Fine-Tuning of LLMs](https://arxiv.org/abs/2606.05516)
...
### [113] [What Objects Enable, Not What They Are: Functional Latent Spaces for Affordance Reasoning](https://arxiv.org/abs/2606.05533)
...
### [114] [Less is MoE: Trimming Experts in Domain-Specialist Language Models](https://arxiv.org/abs/2606.05538)
...
### [115] [Balancing Image Compression and Generation with Bootstrapped Tokenization](https://arxiv.org/abs/2606.05552)
...
### [116] [Representation Learning Enables Scalable Multitask Deep Reinforcement Learning](https://arxiv.org/abs/2606.05555)
...
### [117] [Field Validation of a Multi-Resolution ConvLSTM Framework for Retaining Wall Deformation Prediction](https://arxiv.org/abs/2606.05556)
...
### [118] [Autoregressive Diffusion World Models for Off-Policy Evaluation of LLM Agents](https://arxiv.org/abs/2606.05558)
...
### [119] [CLaaS: Continual learning as a service for sample efficient online learning](https://arxiv.org/abs/2606.05559)
...
### [120] [AsyncWebRL: Efficient Multi-Step RL for Visual Web Agents](https://arxiv.org/abs/2606.05597)
...
### [121] [Mitigating the Curse of Dimensionality in Uniform Convergence of Deep Neural Networks via Smooth Activations](https://arxiv.org/abs/2606.05599)
...
### [122] [From Prediction to Self: Developmental Conditions for Agency in Minimal Neural Systems](https://arxiv.org/abs/2606.05605)
*Evan Ye*
...
### [123] [Cross-Epoch Adaptive Rollout Optimization for RL Post-Training](https://arxiv.org/abs/2606.05606)
...
### [124] [StableRCA: Robust Graph-Agnostic Mechanism-Level Root Cause Analysis](https://arxiv.org/abs/2606.05636)
...
### [125] [Q-GNN: Query-Conditioned Graph Neural Networks with Type Awareness for Knowledge Graph Completion](https://arxiv.org/abs/2606.05639)
...
### [126] [Two-Way Is Better Than One: Bidirectional Alignment with Cycle Consistency for Exemplar-Free Class-Incremental Learning](https://arxiv.org/abs/2606.05675)
...
### [127] [Causal Modeling of Selection in Evolution](https://arxiv.org/abs/2606.05689)
...
### [128] [Benchmarking Counterfactual Prediction in Epidemic Time Series with Time-Varying Interventions](https://arxiv.org/abs/2606.05692)
...
### [129] [MolE-RAG: Molecular Structure-Enhanced Retrieval-Augmented Generation for Chemistry](https://arxiv.org/abs/2606.05693)
...
### [130] [Revisiting Prototype Rehearsal for Exemplar-Free Continual Learning: Manifold-Aware Boundary Sampling with Adaptive Class-Balanced Loss](https://arxiv.org/abs/2606.05695)
*Hongye Xu,Bartosz Krawczyk*
...
### [131] [Intercomparison of Machine Learning Algorithms for Remote Sensing-based In-season Crop Mapping](https://arxiv.org/abs/2606.05731)
...
### [132] [Zero-Copy Semantic Contagion: An In-Memory Streaming Architecture for Evolving Attention Graphs](https://arxiv.org/abs/2606.05733)
*Kabir Murjani*
...
TL;DR: SALT通过子空间适应的梯度重权衡，解决GRPO归一化抵消问题，提升RLVR学习效果


<details>
  <summary>Details</summary>
Motivation: 传统GRPO式组归一化在多次rollout采样下，梯度特征可能聚集低秩符号几何，导致聚合时抵消，削弱更新效果

Method: 利用批次Gram几何估计主共享子空间，分解归一化系数为共享与残差通道，并在符号抵消严重时自适应放大残差通道

Result: 在多种推理导向RLVR基准和模型规模上，SALT在不改动奖励模型或采样流程的前提下，提高了有效更新几何和整体性能

Conclusion: SALT在RLVR中显著提升了有效更新几何结构和性能
...
### [150] [Diffusion Models for Adaptive Sequential Data Generation](https://arxiv.org/abs/2606.06007)
...
### [151] [Adaptive Oscillatory-State Alignment for Time Series Forecasting](https://arxiv.org/abs/2606.06010)
...
### [152] [OPRD: On-Policy Representation Distillation](https://arxiv.org/abs/2606.06021)
...
### [153] [Catastrophic Forgetting as Accessibility Collapse: A Three-Level Framework for Knowledge Persistence in Continual Learning](https://arxiv.org/abs/2606.06032)
...
### [154] [When Good Enough Is Optimal: Multiplication-Only Matrix Inversion Approximation for Quantized Gated DeltaNet](https://arxiv.org/abs/2606.06034)
...
TL;DR: 提出一种基于矩阵乘法的截断 Neumann 展开算法，消除块线性注意力中的矩阵求逆瓶颈，实现 5x 加速、20% 解码开销下降，兼容低位 INT 保留精度。


<details>
  <summary>Details</summary>
Motivation: 在 NPU 上使用前向替换法导致矩阵求逆并行性低、硬件利用率差，成为长上下文建模的主要瓶颈。

Method: 针对块状线性注意力中严格下三角矩阵，设计了基于矩阵乘法的快递算法，利用截断 Neumann 展开、结构掩码和并行残差校正消除顺序依赖；在低位 INT 模型中通过动态范围控制与自适应截断阶数降低计算成本，同时保持模型精度。

Result: 实验验证在 Qwen3.5 系列模型上实现了最高 5 倍内核级速度提升、20% 解码层开销下降，并在浮点及低精度推理下保持准确率。

Conclusion: 提供了一种高效、硬件友好的矩阵乘法基础算法，解决了长上下文建模中矩阵求逆的并行瓶颈，显著提升线性注意力的执行效率并保持精度。
...
### [155] [Online KL-Regularized Reinforcement Learning with Function Approximation under Misspecification](https://arxiv.org/abs/2606.06053)
...
### [156] [MDP-GRPO: Stabilized Group Relative Policy Optimization for Multi-Constraint Instruction Following](https://arxiv.org/abs/2606.06058)
...
### [157] [On Advantage Estimates for Max@K Policy Gradients](https://arxiv.org/abs/2606.06080)
...
### [158] [OrderGrad: Optimizing Beyond the Mean with Order-Statistic Policy Gradient Estimation](https://arxiv.org/abs/2606.06096)
...
TL;DR: 用 LLM 作为直译层，将自然语言请求转为 CoMoMo 预测体系，成功降低技术壁垒，无损准确性


<details>
  <summary>Details</summary>
Motivation: 死亡率预测对保险财务与政策制定关键，但技术门槛高，普通用户难以操作

Method: 三阶段流程：CoMoMo基线管线、滚动原点 MSE 评估多步预测、LLM 本地交互层

Result: 系统验证：LLM 能提升人为交互的便捷性，同时保持可复现、透明及精确性

Conclusion: 兼顾可用性与统计实效，LLM 驱动界面为非专业用户实现可靠死亡率预测方案
...
### [189] [Causal Atlases from Entropic Inference: Bayesian Networks beyond Optimal DAGs](https://arxiv.org/abs/2606.06440)
...
### [190] [In-Context Multiple Instance Learning](https://arxiv.org/abs/2606.06458)
*Alexander Möllers,Marvin Sextro,Julius Hense,Gabriel Dernbach,Klaus-Robert Müller*

Main category: cs.LG

TL;DR: 预训练Perceiver风格的内置学习器在合成数据上学习多任务先验，可在少量标注下一次性推理，完成MIL任务并超过传统监督方法。


<details>
  <summary>Details</summary>
Motivation: 现有MIL模型在少量标签时要么过拟合、要么缺乏适应性，亟需兼顾灵活与稳健的模型。

Method: 使用Perceiver式架构对多种合成数据生成器（为bag结构数据）进行预训练，在推理时采用单次前向传播，无梯度更新；合成器包含互补的先验提示。

Result: 在12个MIL基准测试中，该预训练模型平均性能最高，超过需要任务特定训练的监督基线。

Conclusion: 在低标签环境下，通过在合成数据上预训练的Perceiver型内置学习器可实现一次前向推理的高效MIL分类，并在12个基准上优于传统监督模型。
...
### [191] [Event Detection for Parameter-to-KPI Dependency Learning for AI-RAN](https://arxiv.org/abs/2606.06459)
...
### [192] [PC Layer: Polynomial Weight Preconditioning for Improving LLM Pre-Training](https://arxiv.org/abs/2606.06470)
...
### [193] [RREDCoT: Segment-Level Reward Redistribution for Reasoning Models](https://arxiv.org/abs/2606.06475)
...
### [194] [Pretraining Recurrent Networks without Recurrence](https://arxiv.org/abs/2606.06479)
...
### [195] [Regret Minimization with Adaptive Opponents in Repeated Games](https://arxiv.org/abs/2606.06486)
...
### [196] [TailLoR: Protecting Principal Components in Parameter-Efficient Continual Learning](https://arxiv.org/abs/2606.06494)
...
### [197] [Foundation Models for Wireless Communications: From PHY Intelligence to Network Autonomy](https://arxiv.org/abs/2606.06239)
...
### [198] [Transformer-Enhanced Reinforcement Learning: Fundamentals and Applications in Communication Networks](https://arxiv.org/abs/2606.05208)
