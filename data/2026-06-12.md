...
### [12] [Evaluation of AutoML Frameworks for IDS under Imbalanced Data Conditions of the NSL-KDD Dataset](https://arxiv.org/abs/2606.12611)
...
### [13] [$μ$VLA: On Recurrent Memory for Partially Observable Manipulation in VLA Models](https://arxiv.org/abs/2606.12497)
...
### [14] [Multi-Bitwidth Quantization for LLMs Using Additive Codebooks](https://arxiv.org/abs/2606.12876)
...
### [15] [Out-of-Distribution (OOD) Detectors for Open-Set RF Fingerprinting](https://arxiv.org/abs/2606.12718)
...
### [16] [Improving Crash Frequency Prediction from Simulated Traffic Conflicts Using Machine Learning Based Microsimulation](https://arxiv.org/abs/2606.12500)
...
### [17] [Policy-driven Conformal Prediction for Trustworthy QoT Estimation](https://arxiv.org/abs/2606.12501)
...
### [18] [Dolph2Vec: Self-Supervised Representations of Dolphin Vocalizations](https://arxiv.org/abs/2606.12503)
...
### [19] [Boosting Direct Preference Optimization with Penalization](https://arxiv.org/abs/2606.12505)
*Pengwei Sun*
...
### [20] [Rubric-Guided Self-Distillation: Post-Training Without Rubric Verifiers](https://arxiv.org/abs/2606.12507)
...
### [21] [Crossing the Validation Crisis: Cross-Validation Reduces Benchmarking Variance Surprisingly Well](https://arxiv.org/abs/2606.12552)
...
### [22] [Emerging Flexible Designs for Geospatial Multimodal Foundation Models](https://arxiv.org/abs/2606.12595)
...
### [23] [Viral Proteins Reveal Geometry of Protein Language Models](https://arxiv.org/abs/2606.12609)
...
### [24] [The Mathematics of AI Winters: The mathematical Taxonomy of Paradigm Fragility in AI Winter](https://arxiv.org/abs/2606.12610)
...
### [25] [Fed-FBD: Federated Functional Block Diversification for Isolation, Privacy, and Surgical Unlearning](https://arxiv.org/abs/2606.12679)
...
### [26] [Detecting Functional Memorization in Code Language Models](https://arxiv.org/abs/2606.12764)
...
### [28] [Towards Provably Fair Machine Learning: Bayesian Approaches For Consistent and Transparent Predictions](https://arxiv.org/abs/2606.12615)
...
### [29] [PolicyGuard: Towards Test-time and Step-level Adversary Defense for Reinforcement Learning Agent](https://arxiv.org/abs/2606.12896)
...
### [31] [Two-Layer Linear Auto-Regressive Models Estimate Latent States](https://arxiv.org/abs/2606.12691)
...
### [38] [How Useful is Causal Invariance for Domain Adaptation in Finite-Sample Settings?](https://arxiv.org/abs/2606.12680)
...
### [39] [Forecasting Is Not Attribution: Localizing Decoder Bypass in Graph-Based Neural Marketing Mix Models](https://arxiv.org/abs/2606.12687)
...
### [40] [M*: A Modular, Extensible, Serving System for Multimodal Models](https://arxiv.org/abs/2606.12688)
...
### [41] [LLM-Powered Personalized Glycemic Assessment in Type 2 Diabetes with Wearable Sensor Data](https://arxiv.org/abs/2606.12699)
...
### [42] [A Stabilized Path-Space Approach to Diffusion-Based Posterior Sampling](https://arxiv.org/abs/2606.12710)
...
### [43] [Normative Robustness as a Frontier for Non-Verifiable Reasoning in LLMs](https://arxiv.org/abs/2606.12731)
...
### [44] [Let's Ask Gauss: Improved One-Run Privacy Auditing](https://arxiv.org/abs/2606.12733)
...
### [45] [Physics-Informed Neural Networks and Radial Basis Functions for PDEs with Dirac Delta Sources](https://arxiv.org/abs/2606.12735)
...
### [46] [Deep Unfolded Latent Optimally Partitioned-l2/l1 Networks for Data-driven Block-Sparse Recovery](https://arxiv.org/abs/2606.12740)
...
### [47] [Adaptive Weighted Averaging](https://arxiv.org/abs/2606.12763)
...
TL;DR: 通过改进 Hölder 池化和分层推断，Hölder++ 在多模态 VAE 中实现了更优的生成质量与一致性平衡。


<details>
  <summary>Details</summary>
Motivation: 现有多模态 VAE 在生成质量与跨模态一致性之间存在权衡，难以同时实现真实多样且语义一致的样本。

Method: 提出 Hölder++：①使用无近似的 Hölder 池化实现；②通过扩展网络建模共享与私有（模态特定）表示；③采用分层推断进一步解耦共享与私有表示。

Result: 实验表明 Hölder++ 在生成质量-一致性折衷上始终优于 SOTA，隐空间更结构化，学习到的共享表示对下游任务更具信息。

Conclusion: Hölder++ 成功提升了多模态 VAE 的生成质量和跨模态一致性，并提供更可解耦且可利用的隐变量表示。
...
### [122] [Chirp Parameter Optimization and Distributed Detection for Cooperative RSMA-AFDM Systems](https://arxiv.org/abs/2606.12823)
...
### [123] [Sub-array Selection Optimization for Joint Self-Interference and Multi-User Interference Suppression in FD mMIMO](https://arxiv.org/abs/2606.12831)
...
### [124] [Active Perception for Radio Map Reconstruction in Uncharted 3D Air-Ground Environments](https://arxiv.org/abs/2606.12844)
...
### [125] [Rotatable Antenna-Enabled Near-Field Integrated Sensing and Communication](https://arxiv.org/abs/2606.12870)
...
### [126] [LGVSC: A Large-Model-Driven Generative Video Semantic Communication Framework](https://arxiv.org/abs/2606.12899)
...
### [127] [Simulating Torsional Vibrations of Faulty Bevel Gears Using the Polygonal Contact Method](https://arxiv.org/abs/2606.12967)
...
### [128] [Thermal characterisation by Scanning Photothermal Radiometry using a random undersampled measurement scheme](https://arxiv.org/abs/2606.13046)
...
### [129] [Inverse Learning assisted V2I Communication for Intent Based 6G ISAC Vehicular Networks](https://arxiv.org/abs/2606.13091)
*Anoop C,Anup Aprem*
...
### [130] [A High Input Impedance Chopper Stabilized Amplifier Based On Charge Conservation](https://arxiv.org/abs/2606.13129)
...
### [131] [The Influence of Gain and Phase Mismatches on Beam Patterns in Phased Arrays](https://arxiv.org/abs/2606.13378)
...
### [132] [Towards Standardizing Affine Frequency Division Multiplexing (AFDM) for Future Wireless Networks](https://arxiv.org/abs/2606.13416)
...
### [133] [Mitigating SAR-ADC Non-Idealities in Massive MU-MIMO Systems via Affine Models](https://arxiv.org/abs/2606.13417)
*Jérémy Guichemerre,Christoph Studer*
...
### [134] [Max-Min Secrecy Rate Optimization for Secure ISAC Networks: Global Optimization and Low-Complexity Algorithm](https://arxiv.org/abs/2606.13582)
...
### [135] [Free-Placement Optimization of Ground Station Locations for Low-Earth Orbit Satellites](https://arxiv.org/abs/2606.12667)
...
### [136] [ScaleAcross: Designing Multi-Data-Center Infrastructure for Geo-Distributed AI Training](https://arxiv.org/abs/2606.12963)
...
### [137] [Modular Multi-Domain Digital Twin Architecture: Sustainable Intent-Driven 6G Management](https://arxiv.org/abs/2606.13069)
...
### [138] [Revolutionizing Wireless Communications with Space Data Centers: Applications and Open Challenges](https://arxiv.org/abs/2606.13086)
...
### [139] [Feasibility Assessment of Remote Driving via Latency Analysis of ITS-G5 and Cellular Networks in the MASA Living Lab](https://arxiv.org/abs/2606.13292)
...
### [140] [Measurement-Based Performance Evaluation of SmartRSUs with Heterogeneous Antenna Architectures for V2X Communications](https://arxiv.org/abs/2606.13334)
...
### [141] [Experimental Insights into UDP-Based Video and Control Traffic over IEEE 802.11p ITS-G5](https://arxiv.org/abs/2606.13390)
...
### [142] [From Traditional Automation to Embodied Wireless Intelligence: Vision-Language-Action Empowered Physics-Aware Communication Networks](https://arxiv.org/abs/2606.13458)
...
### [143] [Graphical Causal Reasoning for Root Cause Analysis in Cloud Networks](https://arxiv.org/abs/2606.13532)
...
### [144] [NetCause: Counterfactual Learning for Root Cause Analysis in Large-Scale Networks](https://arxiv.org/abs/2606.13543)
...
### [145] [Modeling and Estimation of Solid Electrolyte Interphase during Formation in Battery Manufacturing](https://arxiv.org/abs/2606.12664)
...
### [146] [Polymer-based Capacitive Micromachined Transducer-Enabled Inline Monitoring of Ultrasonic Welding in Thermoplastic Carbon Fiber Composites](https://arxiv.org/abs/2606.12695)
...
### [147] [Storage and Transport Capacity Design for a Self-Reliable Two-Node Stochastic Resource System](https://arxiv.org/abs/2606.12707)
...
### [148] [Patching Control Lyapunov Barrier Functions for Temporal Logic Specifications with Bounded Controls](https://arxiv.org/abs/2606.12768)
...
### [149] [Agentic MPC for Semantic Control System Resynthesis](https://arxiv.org/abs/2606.12774)
...
### [150] [The GIST 2064-Bus Test System: A Public-Data Synthetic Model of the Korean Power Grid](https://arxiv.org/abs/2606.12791)
*Yun-Su Kim*
...
### [151] [Pushing the Frontiers for Floating Solar Photovoltaics -- The Case for South America](https://arxiv.org/abs/2606.12798)
...
### [152] [Homotopy-Based Re-Initialization for Switched DAEs in Power System Transient Simulation](https://arxiv.org/abs/2606.12803)
...
### [153] [Computing Headway Bounds under Worst-Case Bunching in Fixed-Line Transit Systems](https://arxiv.org/abs/2606.12855)
...
### [154] [Spectrum Sharing Across Terrestrial and Non-Terrestrial Services in the FR3 Upper Midband](https://arxiv.org/abs/2606.13511)
...
### [155] [Data-Driven Frequency-Selective Output Regulation of Nonlinear Systems under Almost Periodic Exosignals](https://arxiv.org/abs/2606.12955)
...
### [156] [Proportional power dispatch and fairness in wind farm power tracking](https://arxiv.org/abs/2606.12989)
...
### [157] [Characterization and Computation of Feedback Nash Equilibria in Scalar Discounted N-Player Linear Quadratic Games](https://arxiv.org/abs/2606.13087)
...
### [158] [MPC for underactuated spacecraft control with a Lyapunov supervised physics-informed neural network correction layer](https://arxiv.org/abs/2606.13113)
...
### [159] [Mitigating business risks from renewable PPA power sourcing uncertainties for European green hydrogen production: Robust system design, regulatory adjustments and offtake flexibility](https://arxiv.org/abs/2606.13215)
...
### [160] [Multi-Phase Optimization of Shared Charging Infrastructure for Freight Electrification](https://arxiv.org/abs/2606.13226)
...
### [161] [Sizing of a grid-forming power converter to improve the small-signal stability of an LCC-HVDC system connected to a weak grid](https://arxiv.org/abs/2606.13358)
...
### [162] [When expectation fails: stochastic MPC of linear systems with random input losses](https://arxiv.org/abs/2606.13421)
...
### [163] [Embodied Opinion Dynamics for Safety-Critical Motion Control in Dynamic Environments](https://arxiv.org/abs/2606.13465)
*Zhiqi Tang,Yu Xing*
...
### [164] [A Reactive Redistribution Mechanism for STL Tasks in Multi-Agent Systems Under Time-Varying Communication](https://arxiv.org/abs/2606.13479)
...
### [165] [Impedance MPC with Patient-Torque Estimation for Knee Rehabilitation Exoskeletons](https://arxiv.org/abs/2606.13485)
...
### [167] [Masked Neural Detection for Constrained Channel Coding in Molecular Communication](https://arxiv.org/abs/2606.12489)
...
### [168] [The Capacity Region for Classes of Sum-Broadcast Channels](https://arxiv.org/abs/2606.12839)
...
### [169] [JSCGC: Joint Source-Channel-Generation Coding for Wireless Generative Communications](https://arxiv.org/abs/2606.12858)
...
### [170] [Pinching-Antenna Enabled Multicell Wireless Systems](https://arxiv.org/abs/2606.12888)
...
### [171] [Bounds and Constructions of Maximum Toroidal Distance Codes](https://arxiv.org/abs/2606.13008)
...
### [172] [Technical Supplement Report on Full-Duplex FBMC/QAM MIMO Systems: Transceiver Design and Optimization](https://arxiv.org/abs/2606.13023)
...
### [173] [Active Sensing-assisted UAV Communications with Jittering: Framework and Performance Analysis](https://arxiv.org/abs/2606.13036)
...
### [174] [Polar Decoding Tree Pruning Based on Soft Output Extraction](https://arxiv.org/abs/2606.13214)
...
### [175] [A $q$-analogue of the rational normal curve and linearized Reed-Solomon codes](https://arxiv.org/abs/2606.13246)
...
### [176] [Error Probability Analysis of Quantum Communication with Phase-squeezed M-PSK](https://arxiv.org/abs/2606.13286)
...
### [177] [$W-δ-μ$ dual codes and LCD codes](https://arxiv.org/abs/2606.13467)
...
### [178] [Fundamental Limits of Hypergraph Edge Partitioning under Independent Edge Sampling](https://arxiv.org/abs/2606.13491)
...
### [179] [Influence Factors on RAG Poisoning](https://arxiv.org/abs/2606.12469)
...
### [180] [From Parameters to Feature Space: Task Arithmetic for Backdoor Mitigation in Model Merging](https://arxiv.org/abs/2606.12498)
...
### [181] [Beyond Attack Success Rate: Examining Trigger Leakage in Vision-Language Agentic Systems](https://arxiv.org/abs/2606.12586)
...
### [182] [Amnesia: A Stealthy Replay Attack on Continual Learning Dreams](https://arxiv.org/abs/2606.12655)
...
### [183] [CAPED: Context-Aware Privacy Exposure Defense for Mobile GUI Agents](https://arxiv.org/abs/2606.12666)
...
### [184] [SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems](https://arxiv.org/abs/2606.12703)
*Tarun Sharma*
...
### [185] [PI-Hunter: Automated Red-Teaming for Exposing and Localizing Prompt Injections](https://arxiv.org/abs/2606.12737)
...
### [186] [LNTest: A Testbed for Evaluating Bitcoin Lightning Network-Based Botnets](https://arxiv.org/abs/2606.12887)
...
### [187] [Semantic Identification of IoT Devices from Behavioral Primitives](https://arxiv.org/abs/2606.12793)
...
### [188] [The Invisible Ink of the Android Malware World: A Longitudinal Study on the Usage of Covert Communication Channels](https://arxiv.org/abs/2606.13107)
...
### [189] [A Privacy-Preserving Framework Using Remote Data Science for Inter-Institutional Student Retention Prediction](https://arxiv.org/abs/2606.12845)
...
### [190] [MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems](https://arxiv.org/abs/2606.12918)
...
### [191] [ViPER: Vision-based Packing-Aware Encoder for Robust Malware Detection](https://arxiv.org/abs/2606.12949)
...
### [192] [SoK: The Constant Time Model](https://arxiv.org/abs/2606.13000)
*Billy Bob Brumley*
...
### [193] [DIG: Oracle-Guided Directed Input Generation for One-Day Vulnerabilities](https://arxiv.org/abs/2606.13037)
...
### [194] [The Emergence of Autonomous Penetration Capabilities in Large Language Model-Powered AI Systems](https://arxiv.org/abs/2606.13079)
...
### [195] [Who Pays the Price? Stakeholder-Centric Prompt Injection Benchmarking for Real-world Web Agents](https://arxiv.org/abs/2606.13385)
...
### [196] [An Assessment Framework for Application-Level Cryptographic Agility](https://arxiv.org/abs/2606.13425)
...
### [197] [Intent-Based Cryptographic API Design for Cryptographic Agility](https://arxiv.org/abs/2606.13445)
*Navaneeth Rameshan,Gregoire Messmer*
...
### [198] [Differentially Private Hierarchical Heavy Hitters](https://arxiv.org/abs/2606.13563)
...
### [199] [Beyond the IT Checklist: Engineering a Reasonable Standard of Care for Cyber Safety](https://arxiv.org/abs/2606.13612)
