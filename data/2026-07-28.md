...
### [28] [Semalith v1.4: A Calibrated 184M Safety Classifier Achieving State-of-the-Art Prompt-Injection Detection at 44x Fewer Parameters than Llama-Guard-3-8B](https://arxiv.org/abs/2607.22545)
*Tejasvi C. Addagada*
...
### [30] [CausalGate: Causal Importance Distillation for Transformer Module Pruning](https://arxiv.org/abs/2607.22720)
...
### [31] [Progress-conditioned Group Policy Optimization for Long-Horizon Agentic Tasks](https://arxiv.org/abs/2607.22724)
...
### [32] [QFedPolyp: A Communication- and Inference-Efficient Federated Learning Framework for Polyp Segmentation](https://arxiv.org/abs/2607.22743)
...
### [33] [Learning to Access Computation: Accessibility Plasticity as a Principle of Adaptive Intelligence](https://arxiv.org/abs/2607.22748)
*Zhaowen Fan*
...
### [34] [Hierarchical Grading in Large Language Models](https://arxiv.org/abs/2607.22757)
*T. Shaska*
...
### [35] [An Integrated Deep Learning and Statistical Framework for Whole-Network Gene--Environment Association with Leaf Vascular Architecture](https://arxiv.org/abs/2607.22763)
...
### [36] [Beyond Shapley: An Influence-Based Data Auditing Pipeline for LLM Alignment and Evaluation](https://arxiv.org/abs/2607.22766)
...
### [37] [DomainPilot: Domain-Level Loss-Guided Two-Stage Data Mixture Optimization for Efficient Language Model Fine-Tuning](https://arxiv.org/abs/2607.22769)
*He Zhang*
...
### [38] [Dementia Etiology Diagnosis via Collaborative Meta Knowledge Enhancement](https://arxiv.org/abs/2607.22770)
...
### [39] [CC-AOS: Cost- and Horizon-Conditioned Amortized Backward Induction for Finite-Horizon Optimal Stopping](https://arxiv.org/abs/2607.22774)
*Tianwei Yu*
...
### [40] [CAPS: Fine-Tuning CCA Timing](https://arxiv.org/abs/2607.22821)
...
### [41] [Twin-Fidelity-Aware Resolution of Direct xApp Conflicts in Open RAN](https://arxiv.org/abs/2607.22857)
...
### [42] [Invariant Discovery for Networked Systems](https://arxiv.org/abs/2607.22944)
...
### [43] [Building AI That Works: ESnet's Pragmatic Approach to AI-Driven Operational Excellence](https://arxiv.org/abs/2607.22948)
...
### [44] [ISAC-Enabled On-Demand UAV Charging for Wireless Rechargeable Sensor Networks](https://arxiv.org/abs/2607.23572)
...
### [45] [TRUAV: Distributed Multi-Agent Reinforcement Learning for Trajectory Planning and Routing Enhancement in UAV-Aided IoT-Enabled VANETs](https://arxiv.org/abs/2607.23734)
...
### [46] [Fake It No More: Evaluating L4S with SCReAM on Video Traffic](https://arxiv.org/abs/2607.23767)
...
### [47] [GNN-based Multi-Agent Control of Traffic Shockwaves in Sparse Vehicular Ad-hoc Networks](https://arxiv.org/abs/2607.23792)
...
### [48] [HAPS-enabled Downlink Coverage Enhancement in Islands and Maritime Areas](https://arxiv.org/abs/2607.23848)
...
### [49] [6G: From Connectivity Infrastructure to Guaranteed Digital Services](https://arxiv.org/abs/2607.24185)
...
### [50] [DeepNC: A Fast GNN-based Pre-Verification Surrogate for TSN Configuration](https://arxiv.org/abs/2607.24398)
...
### [51] [Denial of Deadline: Network-Driven Accuracy Collapse in Distributed Inference Pipelines](https://arxiv.org/abs/2607.24692)
...
### [52] [Census Tract-Level Power Outage Prediction and Sensitivity Analysis During Extreme Events](https://arxiv.org/abs/2607.22871)
...
### [53] [Drift-Aware Multi-Target Space Tug Logistics Using Natural Orbital Precession](https://arxiv.org/abs/2607.22974)
...
### [54] [Actuator-Aware Spatiotemporal Tube Synthesis for Temporal Reach-Avoid-Stay Tasks](https://arxiv.org/abs/2607.23040)
...
### [55] [An Adjoint-Based Differentiable Physics Framework for Online Parameter Inversion in Closed-Brayton Gas-Cooled Reactor Digital Twins](https://arxiv.org/abs/2607.23176)
...
### [56] [Embedded Firmware Development for Flight Control, Telemetry, and Video Streaming for DIY UAV Research](https://arxiv.org/abs/2607.23220)
...
### [57] [Sensitivity Analysis of Dynamic Line Rating for ACSR Conductors using IEEE-738](https://arxiv.org/abs/2607.23536)
...
### [58] [Optimal Microgrid Operation with Open-cycle Ocean Thermal Energy Conversion for Islands](https://arxiv.org/abs/2607.23546)
...
### [59] [Observer-Assisted Relative-Velocity Compensation with LPV-$H_\infty$ Robust Correction for 3D Trajectory Tracking of Underactuated Non-Minimum-Phase AUVs under Ocean Currents](https://arxiv.org/abs/2607.23653)
*Mohammad Sabouri*
...
### [60] [Outcome-Fair Restless Multi-Armed Bandits for Stochastic Deadline Scheduling](https://arxiv.org/abs/2607.23772)
...
### [61] [B-spline shaping for low-thrust interplanetary rendezvous](https://arxiv.org/abs/2607.23790)
*Julio C. Sanchez*
...
### [62] [Flight Envelope Protection for a Hypersonic Glide Vehicle Using Adaptive Safety-Critical Control](https://arxiv.org/abs/2607.23839)
...
### [63] [Bound-Optimized Task Choice for Path Integral Control](https://arxiv.org/abs/2607.23866)
...
### [64] [ReCon: A Resource-Constrained Benchmark for LLM-Based Cybersecurity Compliance Across Ingestion and Retrieval Pipelines](https://arxiv.org/abs/2607.22885)
...
### [65] [A Modular Cyber Range Platform for Smart Energy Systems](https://arxiv.org/abs/2607.22943)
...
### [66] [Practical Post-Quantum Cryptography for Bandwidth Constrained or Non-Terrestrial Networks, and Power Constrained Devices](https://arxiv.org/abs/2607.23007)
...
### [67] [Mask2Shield: Strengthening LLM Safety against Neuron-Pruning Attacks](https://arxiv.org/abs/2607.23015)
...
### [68] [GLST: Defending Confidence-Driven V2X Collaborative Perception Against Stealthy Multi-Attacker Feature Injection](https://arxiv.org/abs/2607.23059)
...
### [69] [Traceable LLM Reasoning for Fake-Order Fraud Detection](https://arxiv.org/abs/2607.23075)
...
### [70] [Poster: Rethinking Security in LLM Code Generation through Real-World Risk Scenarios](https://arxiv.org/abs/2607.23088)
...
### [71] [False Prophets: On the Security of World Models in Agentic Systems](https://arxiv.org/abs/2607.23147)
...
### [72] [SPARC: Automated Root-Cause Analysis of Pre-Silicon Power Side-Channel Leakage in the Processor Design Flow](https://arxiv.org/abs/2607.23218)
...
### [73] [From Signals to Behaviors: Evidence-Based Android Malware Detection](https://arxiv.org/abs/2607.23272)
...
### [74] [Hiding in Plain Sight: An Effective Physical Adversarial Patch Attack against Visual-Infrared Fused Face Detection](https://arxiv.org/abs/2607.23292)
...
### [75] [A Structured Cyber Threat Intelligence Dataset Using STIX 2.1 Entities and MITRE ATT&CK Mappings](https://arxiv.org/abs/2607.23312)
